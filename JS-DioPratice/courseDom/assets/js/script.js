...
const body = document.getElementsByTagName('body')[0];//retorna lista,como so existe um é o [0]
const footer = document.getElementsByTagName('footer')[0];//retorna lista,como so existe um é o [0]
